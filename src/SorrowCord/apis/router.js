 ...
 * @property {SorrowcordRoute[]} routes Registered routes
 */
class RouterAPI extends API {
  ...
  async restorePrevious () {
    return null;
    /*
     * const oldRoute = await DiscordNative.settings.get('_SORROWCORD_ROUTE');
     ...
     * }
     * return DiscordNative.settings.set('_SORROWCORD_ROUTE', void 0);
     */
  }

  /**
   * Registers a route
   * @param {SorrowcordRoute} route Route to register
