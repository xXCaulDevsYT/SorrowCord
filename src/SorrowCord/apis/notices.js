...
/**
 * @typedef SorrowcordAnnouncement
...
/**
 * @property {Object.<String, SorrowcordToast>} toasts
 * @property {Object.<String, SorrowcordAnnouncement>} announcements
 */
module.exports = class NoticesAPI extends API {
   ...
   * @param {SorrowcordAnnouncement} props Announcement
   ...
   * @param {SorrowcordToast} props Toast
